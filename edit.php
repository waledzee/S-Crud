...
<?php 
    ...
    $id = $_GET['id'];
    $sql = "SELECT * FROM `crud_php_mysql2`  WHERE `user_id`='$id' LIMIT 1 ";
    ...
    if(isset($_GET['name']))
    {
        ...
        $sql .= " UPDATE `crud_php_mysql2` SET 'user_name'='.$name.' ,'user_email'='.$email.','password'='.$password.' WHERE `crud_php_mysql2`.`user_id`='.$id ";
...
?>
    ...
    <div class="col-md-6 offset-md-3">
        <form class="my-2 p-3 border" method="GET" action="update.php">
